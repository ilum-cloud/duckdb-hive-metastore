...
# Create sample_db.duck_fixture_bad_type, a table with a column type the extension
# cannot map (idempotent). Run after test-env-start; required for
# test/sql/cache/error_isolation.test.
